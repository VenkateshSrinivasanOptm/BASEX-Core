...
VERSION = 0.0.1
TEMPLATE = lib
DESTDIR = ../gsmservice/interface/lib
TARGET = gsmservice
CONFIG += c++17
MOC_DIR = moc
OBJECTS_DIR = obj
...
SOURCES += \
    impl/src/gsmcbuscomm.cpp \
    impl/src/gsmservice.cpp

HEADERS += \
    impl/src/gsmcbuscomm.h \
    interface/include/gsmservice.h \
    interface/include/gsmservicemessages.h
